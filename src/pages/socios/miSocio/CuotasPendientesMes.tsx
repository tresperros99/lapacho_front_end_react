...
const CuotasPendientesMes = () => {
	...
	const [cuotasPendientesMes, setCuotasPendientes] = useState<CuotasPendiente[]>([]);
	...
	return (
		<ContainerComponent>
			<Typography textAlign={'center'} variant='h4' marginBottom={2}>Panel de Cuotas Pendientes del mes</Typography>
