    ...
    onSubmit: async (nuevoEgreso: NuevoEgresoDto) => {
      ...
      try {
        const formatearDto: NuevoEgresoDto = {
          ...nuevoEgreso,
          fechaPago: formatearFechaLocal(nuevoEgreso.fechaPago),
          montoEngreso: Number(nuevoEgreso.montoEngreso),
        };
        ...
        <Grid container spacing={2}>
          ...
          <Grid item xs={6}>
            <TextField
              ...
              error={
                formik.touched.descripcionEgreso &&
                Boolean(formik.errors.descripcionEgreso)
              }
              helperText={
                formik.touched.descripcionEgreso &&
                formik.errors.descripcionEgreso
              }
            />
          </Grid>
          <Grid item xs={6}>
            <TextField
              ...
              onBlur={formik.handleBlur}
              error={
                formik.touched.montoEngreso &&
                Boolean(formik.errors.montoEngreso)
              }
              helperText={
                formik.touched.montoEngreso && formik.errors.montoEngreso
              }
            />
          </Grid>
          <Grid item xs={6}>
            <TextField
              ...
              onBlur={formik.handleBlur}
              error={
                formik.touched.nroFactura && Boolean(formik.errors.nroFactura)
              }
