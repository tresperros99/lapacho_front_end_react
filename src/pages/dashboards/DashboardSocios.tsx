  ...
  return (
    <ContainerComponent>
        ...
        <Grid item xs={12} sm={6}>
            ...
            <ResponsiveContainer width="100%" height={300}>
                <PieChart>
                <Pie data={dataCategorias} dataKey="cantidad" nameKey="categoria" cx="50%" cy="50%" outerRadius={100} label>
        ...
        <Grid item xs={12} sm={6}>
            ...
            <ResponsiveContainer width="100%" height={300}>
                ...
                <PolarRadiusAxis />
                <Tooltip />
                <Radar name="Edad Promedio" dataKey="edadPromedio" stroke="#8884d8" fill="#8884d8" fillOpacity={0.6} />
                </RadarChart>
            </ResponsiveContainer>
            </Paper>
        </Grid>

        {/* Fila 3: Gráfico de barras con categorías y gráfico de líneas con más detalles */}
        <Grid item xs={12} sm={6}>
            <Paper elevation={3} style={{ padding: "16px" }}>
            <Typography variant="h6" gutterBottom>
